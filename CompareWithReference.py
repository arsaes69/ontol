...
#compareWithReference("output/anatomy-reference-mappings.ttl","data/anatomy-example-system-mappings.ttl")

# For the lab you should compare, for example, 
# cmt-confOf-reference.ttl with the cmt-confOf-your-system.ttl you generate.
#compareWithReference("data/cmt-ekaw-reference-mappings.ttl", "output/cmt-ekaw.ttl")
#compareWithReference("data/cmt-confOf-reference-mappings.ttl", "output/cmt-confOf.ttl")
compareWithReference("data/confOf-ekaw-reference-mappings.ttl", "output/confOf-ekaw.ttl")